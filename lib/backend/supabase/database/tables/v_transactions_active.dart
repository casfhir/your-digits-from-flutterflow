...
class VTransactionsActiveTable extends SupabaseTable<VTransactionsActiveRow> {
  @override
  String get tableName => 'v_transactions_active';

  @override
  VTransactionsActiveRow createRow(Map<String, dynamic> data) =>
      VTransactionsActiveRow(data);
}

class VTransactionsActiveRow extends SupabaseDataRow {
  VTransactionsActiveRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VTransactionsActiveTable();
