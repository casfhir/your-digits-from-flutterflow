...
class VAccountsActiveTable extends SupabaseTable<VAccountsActiveRow> {
  @override
  String get tableName => 'v_accounts_active';

  @override
  VAccountsActiveRow createRow(Map<String, dynamic> data) =>
      VAccountsActiveRow(data);
}

class VAccountsActiveRow extends SupabaseDataRow {
  VAccountsActiveRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VAccountsActiveTable();
