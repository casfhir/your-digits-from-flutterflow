...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3994EF);
  late Color secondary = const Color(0xFF4DA167);
  late Color tertiary = const Color(0xFFFF6542);
  late Color alternate = const Color(0xFFF0EFF4);
  late Color primaryText = const Color(0xFF253237);
  late Color secondaryText = const Color(0xFF747C82);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFEF5B5B);
  late Color tertiary = const Color(0xFFFFBA49);
  late Color alternate = const Color(0xFF262D34);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFF23001E);
  late Color secondaryBackground = const Color(0xFF2C2C54);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
