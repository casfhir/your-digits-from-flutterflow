...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? SummaryWidget() : AuthSignUpWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: AddAccountWidget.routeName,
          path: AddAccountWidget.routePath,
          builder: (context, params) => AddAccountWidget(),
        ),
        FFRoute(
          name: EditTransactionWidget.routeName,
          path: EditTransactionWidget.routePath,
