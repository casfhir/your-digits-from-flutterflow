...
class AddAccountWidget extends StatefulWidget {
  ...
  static String routePath = '/addAccount';
            ...
            child: FloatingActionButton(
              onPressed: () async {
                await AccountsTable().insert({
                  ...
                  'is_savings': _model.subtypeValue == 'saving' ? true : false,
                  'startingbalance': double.tryParse(
                      _model.startingBalanceTextController.text),
                  'subtype': _model.subtypeValue,
                  'opening_date': supaSerialize<DateTime>(_model.datePicked),
                });
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  20.0, 0.0, 20.0, 0.0),
                              child: FlutterFlowDropDown<String>(
                                controller: _model.subtypeValueController ??=
                                    FormFieldController<String>(null),
                                options: [
                                  'cash',
                                  'saving',
                                ...
                                onChanged: (val) async {
                                  safeSetState(() => _model.subtypeValue = val);
                                  _model.selectedSubtype = _model.subtypeValue;
                                  safeSetState(() {});
                                },
                                height: 40.0,
                                textStyle: FlutterFlowTheme.of(context)
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              ...
                              text: dateTimeFormat("MMMEd", _model.datePicked),
                        ...
                        Expanded(
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                20.0, 10.0, 20.0, 0.0),
                            child: TextFormField(
                              controller: _model.startingBalanceTextController,
